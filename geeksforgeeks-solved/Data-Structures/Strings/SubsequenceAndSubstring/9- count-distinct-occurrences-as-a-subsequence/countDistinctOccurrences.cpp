/*
 * Topic: Count distinct occurrences as a subsequence
 *
 * Description: Given a two strings S and T, find the
 * count of distinct occurrences of T in S as a subsequence.
 */
#include <iostream>
#include <vector>
#include <math.h>
...
int countDistinctOccurrences(string a, string b) {
...
int main() {
    ...
    cout << countDistinctOccurrences(a, b) << endl;
    
    string a2 = "geeksforgeeks";
    string b2 = "ge";
    
    cout << countDistinctOccurrences(a2, b2) << endl;
